  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved feed as @feed" do
        ...
        post :create, {:feed => { "uid" => "invalid value" }}, valid_session
        assigns(:feed).should be_a_new(Feed)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested feed" do
        ...
        Feed.any_instance.should_receive(:update_attributes).with({ "uid" => "" })
        put :update, {:id => feed.to_param, :feed => { "uid" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the feed as @feed" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Feed.any_instance.stub(:save).and_return(false)
        put :update, {:id => feed.to_param, :feed => { "uid" => "invalid value" }}, valid_session
        assigns(:feed).should eq(feed)
      end
